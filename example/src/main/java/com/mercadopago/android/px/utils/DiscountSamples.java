...
final class DiscountSamples {
    ...
    public static void addAll(final Collection<Pair<String, MercadoPagoCheckout.Builder>> options) {
        options.add(
            new Pair<>("Discount - Direct", getMercadoPagoBuilder(PK_WITH_DIRECT_DISCOUNT, PREF_WITH_DIRECT_DISCOUNT)));
        options
            .add(new Pair<>("Discount - Code", getMercadoPagoBuilder(PK_WITH_CODE_DISCOUNT, PREF_WITH_CODE_DISCOUNT)));
    ...
    private static MercadoPagoCheckout.Builder getMercadoPagoBuilderWithAlwaysOnDiscountWithPercentOff(
        ...
        return new MercadoPagoCheckout.Builder(publicKey, prefId)
            .setPaymentProcessor(getMainPaymentProcessor())
            .setDiscount(getDiscount(), campaign);
    }
    ...
    private static MainPaymentProcessor getMainPaymentProcessor() {
        ...
        return new MainPaymentProcessor(businessPayment);
    }
